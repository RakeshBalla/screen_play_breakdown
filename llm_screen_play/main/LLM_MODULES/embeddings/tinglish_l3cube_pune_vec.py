...
# Five Tinglish sentences on different topics
import openai
...
# sentences = [
#     "Aa roju Friday, mee amma nee box lo royyala vepudu pettindhi, adhi thinna rojey decide ayya, ayithey mee intiki alludu avvaalani, mee amma chesina kurala kosamey nenu ninnu preminchanu Asha.",  # Topic: Fitness
#     "Rendu rojulu nunchi maa mavayya phone lift cheyyatledu ante edho important panilo vunnattu vunnaaduraa.",       # Topic: Movies
#     "Mee nanna em chestado, elaa react avuthado nuvvu elaa decide avuthavu?"  # Topic: Shopping
#     "Exams ki prep start chesa, notes anni ready ayyayi.",       # Topic: Studies
#     "Weekend lo picnic plan chestunna, beach side ki vellali."    # Topic: Travel
# ]
...
# Example question
question = "1st year class room ki evaru vacharu , valla peru enti"  # Asking about travel plans

# Get the relevant sentence
relevant_sentence, similarity_score = get_relevant_sentence(question, sentences, embeddings)

# Print results
print("Sentences and their embeddings:")
for i, sentence in enumerate(sentences):
    print(f"Sentence {i+1}: {sentence}")
    print(f"Embedding: {embeddings[i][:5]}... (first 5 values for brevity)")
    print()
